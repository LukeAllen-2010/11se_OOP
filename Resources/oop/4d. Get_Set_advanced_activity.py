#LEARNING INTENTIONS:
#Practice manipulating data in lists of pets
...
#2. Add 2 more animals, including one dog
#3. Loop through the animal list and print out information only for the dogs
